 ...
 */
fun Any.getPropertyValue(propertyName: String): Any? = this::class.findProperty(propertyName)?.getter?.call(this)
 ...
 */
@Suppress("UNCHECKED_CAST")
fun <T> Any.getPropertyValueAs(propertyName: String): T? = getPropertyValue(propertyName) as? T
