...
fun Any?.toGoogleProtobufAny(): GoogleProtobufAny {
    return when (this) {
        is String -> GoogleProtobufAny.pack(StringValue.of(this))
        is Int -> GoogleProtobufAny.pack(Int32Value.of(this))
        is Long -> GoogleProtobufAny.pack(Int64Value.of(this))
        is Double -> GoogleProtobufAny.pack(DoubleValue.of(this))
        is Float -> GoogleProtobufAny.pack(FloatValue.of(this))
        is Boolean -> GoogleProtobufAny.pack(BoolValue.of(this))
        is Char -> GoogleProtobufAny.pack(Int32Value.of(code))
        is Short -> GoogleProtobufAny.pack(Int32Value.of(toInt()))
        is Byte -> GoogleProtobufAny.pack(Int32Value.of(toInt()))
        is ByteString -> GoogleProtobufAny.pack(BytesValue.of(this))
        is ByteArray -> GoogleProtobufAny.pack(BytesValue.of(ByteString.copyFrom(this)))
        else -> GoogleProtobufAny.newBuilder().build()
    }
}
