...
class JacksonService {
    ...
    constructor(mapper: ObjectMapper, initializer: ObjectMapper.() -> Unit = {}, kotlinModuleInitializer: KotlinModule.Builder.() -> Unit = {}) {
        objectMapper = mapper.copy().apply(initializer).registerModule(
