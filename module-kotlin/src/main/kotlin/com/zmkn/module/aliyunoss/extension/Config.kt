...
fun Config.toCredentialsProvider(): CredentialsProvider = CredentialsProviderFactory.newDefaultCredentialProvider(id, secret)

fun Config.toClientConfiguration(): ClientConfiguration = ClientBuilderConfiguration().also {
