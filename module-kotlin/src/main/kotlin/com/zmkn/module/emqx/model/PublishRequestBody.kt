...
data class PublishRequestBody(
    ...
    @JsonSerialize(using = PayloadEncoding.PayloadEncodingJacksonSerializer::class)
    @JsonDeserialize(using = PayloadEncoding.PayloadEncodingJacksonDeserializer::class)
    ...
    data class Properties(
        ...
        @JsonSerialize(using = ContentType.ContentTypeJacksonSerializer::class)
        @JsonDeserialize(using = ContentType.ContentTypeJacksonDeserializer::class)
